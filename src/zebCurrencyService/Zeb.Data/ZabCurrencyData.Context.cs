...
namespace Zeb.Data
{
    ...
    public partial class ZabCurrencyDbEntities : DbContext, IDbContext
    {
        public ZabCurrencyDbEntities()
            : base("name=ZabCurrencyDbEntities")
        {
        }
